 ...
 * Size: 16 px
 * Bpp: 4
 * Opts: --bpp 4 --size 16 --font E:/Programming/LVGL/demoTest1/assets/Alibaba_PuHuiTi_Regular.ttf -o E:/Programming/LVGL/demoTest1/assets\ui_font_Font16bpp4.c --format lvgl -r 0x20-0x7f --symbols 大小心跳测试弹切换增加红色蓝色返回函数屏幕减小 --no-compress --no-prefilter
 ******************************************************************************/

#include "../ui.h"

#ifndef UI_FONT_FONT16BPP4
#define UI_FONT_FONT16BPP4 1
#endif

#if UI_FONT_FONT16BPP4
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0x0, 0x5, 0xff, 0xb2, 0xb, 0xb2, 0xe8, 0x0,
    ...
    0x0, 0x7, 0xc0, 0x4, 0x44, 0x44, 0x44, 0x10,
    0x0, 0x1f, 0x40, 0x1f, 0xff, 0xff, 0xff, 0x50,
    0x0, 0xba, 0x3, 0x90, 0x1, 0xf3, 0x0, 0x0,
    0x8, 0xf4, 0x4d, 0x70, 0x1, 0xf3, 0x0, 0x0,
    0xf, 0xed, 0xfd, 0x0, 0x1, 0xf3, 0x0, 0x0,
    0x0, 0x3, 0xf3, 0x0, 0x1, 0xf3, 0x0, 0x0,
    0x0, 0x1e, 0x60, 0x0, 0x1, 0xf3, 0x0, 0x0,
    0x1, 0xcd, 0x79, 0x70, 0x1, 0xf3, 0x0, 0x0,
    0xa, 0xfd, 0xb9, 0x40, 0x1, 0xf3, 0x0, 0x0,
    0x1, 0x0, 0x0, 0x0, 0x1, 0xf3, 0x0, 0x0,
    0x0, 0x14, 0x7b, 0x90, 0x1, 0xf3, 0x0, 0x0,
    0x3e, 0xfe, 0xb8, 0x52, 0x23, 0xf5, 0x22, 0x20,
    0x15, 0x20, 0x0, 0xcf, 0xff, 0xff, 0xff, 0xf0,
    ...
    0x0, 0x2f, 0x40, 0xe6, 0x31, 0x0, 0x0, 0x0,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 3864, .adv_w = 252, .box_w = 16, .box_h = 16, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 3992, .adv_w = 252, .box_w = 13, .box_h = 14, .ofs_x = 1, .ofs_y = -2},
    {.bitmap_index = 4083, .adv_w = 252, .box_w = 15, .box_h = 15, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 4196, .adv_w = 252, .box_w = 15, .box_h = 15, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 4309, .adv_w = 252, .box_w = 13, .box_h = 15, .ofs_x = 1, .ofs_y = -2},
    {.bitmap_index = 4407, .adv_w = 252, .box_w = 15, .box_h = 16, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 4527, .adv_w = 252, .box_w = 15, .box_h = 15, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 4640, .adv_w = 252, .box_w = 16, .box_h = 15, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 4760, .adv_w = 252, .box_w = 16, .box_h = 16, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 4888, .adv_w = 252, .box_w = 16, .box_h = 15, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 5008, .adv_w = 252, .box_w = 15, .box_h = 16, .ofs_x = 1, .ofs_y = -2},
    {.bitmap_index = 5128, .adv_w = 252, .box_w = 16, .box_h = 14, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 5240, .adv_w = 252, .box_w = 16, .box_h = 15, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 5360, .adv_w = 252, .box_w = 16, .box_h = 16, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 5488, .adv_w = 252, .box_w = 15, .box_h = 15, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 5601, .adv_w = 252, .box_w = 16, .box_h = 14, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 5713, .adv_w = 252, .box_w = 15, .box_h = 16, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 5833, .adv_w = 252, .box_w = 16, .box_h = 15, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 5953, .adv_w = 252, .box_w = 16, .box_h = 15, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 6073, .adv_w = 252, .box_w = 15, .box_h = 15, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 6186, .adv_w = 252, .box_w = 16, .box_h = 15, .ofs_x = 0, .ofs_y = -2}
};
...
static const uint16_t unicode_list_1[] = {
    0x0, 0x2e, 0x38, 0xd1, 0x50f, 0x6cf, 0x758, 0xa40,
    0xa80, 0xc86, 0xd6a, 0xdf4, 0x1193, 0x13a1, 0x1b7c, 0x2cd3,
    0x30a3, 0x330e, 0x3a06, 0x3c24, 0x3e05
};
...
static const lv_font_fmt_txt_cmap_t cmaps[] =
{
    ...
    {
        .range_start = 20943, .range_length = 15878, .glyph_id_start = 96,
...
#if LV_VERSION_CHECK(8, 0, 0)
const lv_font_t ui_font_Font16bpp4 = {
#else
lv_font_t ui_font_Font16bpp4 = {
#endif
